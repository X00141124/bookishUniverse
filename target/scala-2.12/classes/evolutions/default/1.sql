...
alter table product add constraint fk_product_author_id foreign key (author_id) references author (id) on delete restrict on update restrict;
create index ix_product_author_id on product (author_id);

alter table product add constraint fk_product_publisher_id foreign key (publisher_id) references publisher (id) on delete restrict on update restrict;
...
alter table product drop constraint if exists fk_product_author_id;
drop index if exists ix_product_author_id;

alter table product drop constraint if exists fk_product_publisher_id;
drop index if exists ix_product_publisher_id;
